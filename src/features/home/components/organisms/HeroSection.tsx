...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        <img src="/green 2.png" alt="" className="h-[120%] w-[110%] object-cover" />
      </div>
      ...
      >
        <img src="/green 1.png" alt="" className="h-[50%] w-[110%] object-cover" />
      </div>
      ...
      <ul className="pointer-events-none absolute inset-0 z-4 m-0 list-none p-0">
        ...
        <li className="absolute right-[8%] top-[48%]">
          <FloatingPill animation="float-delayed">Smart Vendor Match</FloatingPill>
        </li>
        ...
        <li className="absolute right-[8%] top-[65%]">
          <FloatingPill animation="float-slow-delayed">Green Market</FloatingPill>
        </li>
      </ul>
      ...
      >
        ...
        >
          ...
          />
          membantu perusahaan industri memvalidasi proyek efisiensi energi, menyusun blueprint dan memantau ROI dalam satu ekosistem yang terukur dan transparan.
        </p>

        <nav className="pointer-events-auto mt-10 flex gap-[46px]" aria-label="Hero actions">
