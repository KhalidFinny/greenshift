...
packages/
  ui/             Design system: shadcn components, Header/Footer, RoleShell, cn
...
`@greenshift/api`, so client and server share one typed contract.
...
| Table | Purpose |
|---|---|
| `users` | Accounts for the three login roles. |
