...
> For the team trying the frontend. The dev server simulates everything locally (API, D1, KV, R2), so **no external backend needed**.
...
| `packages/investor` | Public obligasi dashboard (catalog) |
